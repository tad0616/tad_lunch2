...
while($all=$xoopsDB->fetchArray($result)){
  ...
  $name="";
  if(!empty($main_food) and $show_main_food)$name.=$main_food_for.$main_food."\n";
  if(!empty($main_dish) and $show_main_dish)$name.=$main_dish_for.$main_dish."\n";
  if(!empty($side_dish1) and $show_side_dish1)$name.=$side_dish1_for.$side_dish1."\n";
  if(!empty($side_dish2) and $show_side_dish2)$name.=$side_dish2_for.$side_dish2."\n";
  if(!empty($side_dish3) and $show_side_dish3)$name.=$side_dish3_for.$side_dish3."\n";
  if(!empty($fruit) and $show_fruit)$name.=$fruit_for.$fruit."\n";
  if(!empty($soup) and $show_soup)$name.=$soup_for.$soup."\n";
