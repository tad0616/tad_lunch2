  ...
  <form action="<{$action}>" method="post" id="myForm" enctype="multipart/form-data" role="form">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="input-group">
          <div class="input-group-prepend">
              <span class="input-group-text"><{$smarty.const._MD_TADLUNCH2_PROTEIN}></span>
          </div>
      ...
      <div class="col-md-3">
        <div class="input-group">
          <div class="input-group-prepend">
              <span class="input-group-text"><{$smarty.const._MD_TADLUNCH2_FAT}></span>
          </div>
      ...
      <div class="col-md-3">
        <div class="input-group">
          <div class="input-group-prepend">
              <span class="input-group-text"><{$smarty.const._MD_TADLUNCH2_CARBOHYDRATE}></span>
          </div>
      ...
      <div class="col-md-3">
        <div class="input-group">
          <div class="input-group-prepend">
              <span class="input-group-text"><{$smarty.const._MD_TADLUNCH2_CALORIE}></span>
          </div>
...
<{if $now_op=="show_one_tad_lunch2_data"}>
  ...
  <{foreach from=$all_data item=all}>
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        <span class="badge badge-success"><{$smarty.const._MD_TADLUNCH2_PROTEIN}></span>
        <{$all.protein}>g
      </div>

      <div class="col-md-2">
        <span class="badge badge-warning"><{$smarty.const._MD_TADLUNCH2_FAT}></span>
        <{$all.fat}>g
      </div>

      <div class="col-md-2">
        <span class="badge badge-danger"><{$smarty.const._MD_TADLUNCH2_CARBOHYDRATE}></span>
        <{$all.carbohydrate}>g
      </div>

      <div class="col-md-2">
        <span class="badge badge-info"><{$smarty.const._MD_TADLUNCH2_CALORIE}></span>
        <{$all.calorie}>g
      </div>
